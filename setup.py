...
setup(name='mosaicode',
      ...
      packages=[
          ...
          'mosaicode.extensions.c',
          'mosaicode.extensions.c.opencv',
          'mosaicode.extensions.c.ports',
          'mosaicode.extensions.javascript',
          'mosaicode.extensions.javascript.webaudio',
          'mosaicode.extensions.javascript.ports',
          'mosaicode.control',
          'mosaicode.model'],
