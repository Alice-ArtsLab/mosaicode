...
class Smooth(Plugin):
    ...
    def __init__(self):
        ...
        self.in_types = ["mosaicode.extensions.c.ports.image", "mosaicode.extensions.c.ports.int"]
        self.out_types = ["mosaicode.extensions.c.ports.image", "mosaicode.extensions.c.ports.int", "mosaicode.extensions.c.ports.int"]
