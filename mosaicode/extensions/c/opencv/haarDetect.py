...
class HaarDetect(Plugin):
    ...
    def __init__(self):
        ...
        self.out_types = ["mosaicode.extensions.c.ports.point", "mosaicode.extensions.c.ports.rect", "mosaicode.extensions.c.ports.image", "mosaicode.extensions.c.ports.double"]
