...
long int CheckForColor(IplImage * src, IplImage * dst, uchar * c_value, uchar * tolerance, CvPoint * pointCenter, double * variance)
{
	...
	return numOfPoints;
		...
		makeFileEntry = "export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:"+installDirName+"/lib/; export PKG_CONFIG_PATH="+installDirName+"/lib/pkgconfig/;gcc -x c++ -o " + codeFilename[:-2] + " `pkg-config --cflags --libs opencv` " + codeFilename
		#   makeFileEntry = r"all: " + codeFilename + "\n\tgcc " + codeFilename + r""" -I/opt/harpia/include/ -L/opt/harpia/include/ -lopencv -lcvaux -lhighgui -o """ + codeFilename[:-2]
		makeFile = open(makeFilename, 'w')
		makeFile.write(makeFileEntry)
		makeFile.close()
		...
		yield [_("Compiling ...")]
		if os.name=="nt":
#        gcc.exe "C:\tmp\harpiaBETMP01178664493.78\harpiaBETMP01178664493.78.c" -o "C:\tmp\harpiaBETMP01178664493.78\harpiaBETMP01178664493.78.exe"   -IC:/harpiaBE/include  -LC:/harpiaBE/lib -lcv -lcxcore -lhighgui  -I"C:\Dev-Cpp\include"   -L"C:\Dev-Cpp\lib" 
