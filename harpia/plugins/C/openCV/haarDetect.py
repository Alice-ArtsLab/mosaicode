...
# ------------------------------------------------------------------------------
    def __init__(self):
        ...
        self.help = 'Haar (face) Detector finds regions on the input image according to the given haar-classifier. \n' + \
        'First Output is the center of the first detected feature, second is a rectangle around the first ' + \
        'detected feature and the third is the input image with the detected features tagged by a red circle.\n' + \
