...
# ------------------------------------------------------------------------------
    def __init__(self):
        ...
        self.help = "Operador de binarização da imagem, de acordo com um valor fixo de intensidade luminosa (valor de limiar)."
        ...
        self.function_call = \
            ...
            'cvThreshold(block$id$_img_i0, block$id$_img_o0, $threshold$, $maxValue$, $thresholdType$);\n'+ \
            '}\n'
