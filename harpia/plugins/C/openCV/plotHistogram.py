...
# ------------------------------------------------------------------------------
    ...
    def generate(self, blockTemplate):
        ...
        blockTemplate.functionCall = '\nif(block$id$_img_i1 && block$id$_img_i1->nChannels == 3){\n' + \
             ...
             ' NULL,block$id$_img_o1);\n' + \
             '}\n' + \
             'else\n' + \
             '{\n' + \
             '	block$id$_img_o1 = cvCreateImage(cvSize(255,300), IPL_DEPTH_8U,1);\n' + \
             '	block$id$_SourceCx[0] = cvCreateImage(cvSize(block$id$'+ \
             '_img_i1->width,block$id$_img_i1->height), IPL_DEPTH_8U, 1);\n' + \
             '	block$id$_hist_rang[0] = 0;\n' + \
             '	block$id$_hist_rang[1] = 255;\n' + \
             ...
             '		block$id$_histV=(int)((block$id$_histBin/block$id$_histMaxVal)*300);\n' + \
             '		block$id$_histV=block$id$_img_o1->height - 1 - block$id$_histV;\n' + \
             '		cvLine(block$id$_img_o1, cvPoint(block$id$_plotHistArrIter ,block$id$_histV), cvPoint(block$id$_plotHistArrIter,block$id$_img_o1->height' \
        ...
        blockTemplate.dealloc = 'if(block$id$_SourceCx[0]) cvReleaseImage(&block$id$_SourceCx[0]);\n' + \
            ...
            'if(block$id$_img_i1) cvReleaseImage(&block$id$_img_i1);\n' + \
            'if(block$id$_img_o1) cvReleaseImage(&block$id$_img_o1);\n' + \
