...
class Menu(Gtk.MenuBar):
    ...
    def __init__(self, main_window):
        ...
        edit_menu.append(Gtk.SeparatorMenuItem())
        self.__create_menu("Clear Console", "<Control>L", edit_menu, mc.clear_console)
        edit_menu.append(Gtk.SeparatorMenuItem())
        ...
        self.__create_menu("Normal Size", "<Control>0", view_menu, mc.zoom_normal)
    ...
    def update_recent_file(self):
        ...
        for recent_file in harpia.s2idirectory.properties.get_recent_files_as_array():
