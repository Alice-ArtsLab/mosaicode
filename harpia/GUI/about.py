...
#-------------------------------------------------------------------------------#
#-------------------------------About Text--------------------------------------#
        labelAbout = Gtk.Label('Harpia Project was one of the aproved projects under CT-INFO 2003 Edital.\n' +\
                                      'This project intends to build a graphical environment for learning,\n' +\
                                      'implementing and management of machine vision systems.\n\n' +\
                                      'The system is (would-be) made of several software modules for hardware\n' +\
                                      'comunication, image (signal) processing and remote management of vision\n' +\
                                      'systems.\n\n' +\
...
#-----------------------------Development part----------------------------------#        
        ...
        gridFrame3.attach_next_to(x, developmentBox, Gtk.PositionType.BOTTOM, 1, 2)
...
#------------------------------Placing everything-------------------------------#        
        ...
        grid.attach_next_to(notebook, frameBorder, Gtk.PositionType.BOTTOM, 1, 2)
