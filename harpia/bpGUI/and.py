...
class Properties( GladeWindow, S2iCommonProperties ):
    ...
    def __init__( self, PropertiesXML, S2iBlockProperties):
        ...
        handlers = [
            'on_ANDBackColorButton_clicked',
            'on_ANDBorderColorButton_clicked',
            'on_and_cancel_clicked',
        ...
        self.widgets['ANDBorderColor'].modify_bg(gtk.STATE_NORMAL,t_oBorderColor)        
        ...
        self.widgets['ANDBackgroundColor'].modify_bg(gtk.STATE_NORMAL,t_oBackColor)
    ...
    def on_and_cancel_clicked( self, *args ):
    ...
    def on_ANDBackColorButton_clicked(self,*args):

        t_oColor = self.RunColorSelection()

        if t_oColor <> None:
            
            self.widgets['ANDBackgroundColor'].modify_bg(gtk.STATE_NORMAL,t_oColor)
    ...
    def on_ANDBorderColorButton_clicked(self,*args):

        t_oColor = self.RunColorSelection()

        if t_oColor <> None:
            
            self.widgets['ANDBorderColor'].modify_bg(gtk.STATE_NORMAL,t_oColor)
