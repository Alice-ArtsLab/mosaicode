...
class Properties( GladeWindow, S2iCommonProperties ):
    ...
    def on_prop_confirm_clicked( self, *args ):
			...
			for Property in self.m_oPropertiesXML.properties.block.property:
				if Property.name == "qThresh":
					Property.value = unicode(self.widgets['qThresh'].get_value())
				if Property.name == "minC":
					Property.value = unicode(self.widgets['minC'].get_value())
				if Property.name == "maxG":
					Property.value = unicode(self.widgets['maxG'].get_value())
				if Property.name == "aX":
					Property.value = unicode(self.widgets['aX'].get_value())
				if Property.name == "aY":
					Property.value = unicode(self.widgets['aY'].get_value())
				if Property.name == "aR":
					Property.value = unicode(self.widgets['aR'].get_value())
				if Property.name == "bX":
					Property.value = unicode(self.widgets['bX'].get_value())
				if Property.name == "bY":
					Property.value = unicode(self.widgets['bY'].get_value())
				if Property.name == "bR":
					Property.value = unicode(self.widgets['bR'].get_value())
