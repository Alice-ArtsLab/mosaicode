...
class Properties( GladeWindow, S2iCommonProperties ):
    ...
    def __init__( self, PropertiesXML, S2iBlockProperties):
        ...
        handlers = [ 
            'on_erode_cancel_clicked',
            'on_erode_confirm_clicked',
            'on_ERODBorderColorButton_clicked',
            'on_ERODBackColorButton_clicked'
            ]
        ...
        self.widgets['ERODBorderColor'].modify_bg(gtk.STATE_NORMAL,t_oBorderColor)        
        ...
        self.widgets['ERODBackgroundColor'].modify_bg(gtk.STATE_NORMAL,t_oBackColor)
        ...
        self.widgets['ERODHelpView'].set_buffer( t_oTextBuffer )
    ...
    def on_erode_cancel_clicked( self, *args ):
    ...
    def on_ERODBackColorButton_clicked(self,*args):

        t_oColor = self.RunColorSelection()

        if t_oColor <> None:
            
            self.widgets['ERODBackgroundColor'].modify_bg(gtk.STATE_NORMAL,t_oColor)
    ...
    def on_ERODBorderColorButton_clicked(self,*args):

        t_oColor = self.RunColorSelection()

        if t_oColor <> None:
            
            self.widgets['ERODBorderColor'].modify_bg(gtk.STATE_NORMAL,t_oColor)
