...
class Properties( GladeWindow, S2iCommonProperties ):
    ...
    def __init__( self, PropertiesXML, S2iBlockProperties):
        ...
        self.widgets['SMOOBorderColor'].modify_bg(gtk.STATE_NORMAL,t_oBorderColor)        
        ...
        self.widgets['SMOOBackgroundColor'].modify_bg(gtk.STATE_NORMAL,t_oBackColor)
    ...
    def on_smooth_cancel_clicked( self, *args ):
    ...
    def on_SMOOBackColorButton_clicked(self,*args):

        t_oColor = self.RunColorSelection()

        if t_oColor <> None:
            
            self.widgets['SMOOBackgroundColor'].modify_bg(gtk.STATE_NORMAL,t_oColor)
    ...
    def on_SMOOBorderColorButton_clicked(self,*args):

        t_oColor = self.RunColorSelection()

        if t_oColor <> None:
            
            self.widgets['SMOOBorderColor'].modify_bg(gtk.STATE_NORMAL,t_oColor)
