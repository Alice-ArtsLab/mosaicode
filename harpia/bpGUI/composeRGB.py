...
class Properties( GladeWindow, S2iCommonProperties ):
    ...
    def __init__( self, PropertiesXML, S2iBlockProperties):
        ...
        handlers = [
            'on_CRGBBackColorButton_clicked',
            'on_CRGBBorderColorButton_clicked',
            'on_composeRGB_cancel_clicked',
        ...
        self.widgets['CRGBBorderColor'].modify_bg(gtk.STATE_NORMAL,t_oBorderColor)        
        ...
        self.widgets['CRGBBackgroundColor'].modify_bg(gtk.STATE_NORMAL,t_oBackColor)
        ...
        self.widgets['CRGBHelpView'].set_buffer( t_oTextBuffer )
    ...
    def on_composeRGB_cancel_clicked( self, *args ):
    ...
    def on_CRGBBackColorButton_clicked(self,*args):

        t_oColor = self.RunColorSelection()

        if t_oColor <> None:
            
            self.widgets['CRGBBackgroundColor'].modify_bg(gtk.STATE_NORMAL,t_oColor)
    ...
    def on_CRGBBorderColorButton_clicked(self,*args):

        t_oColor = self.RunColorSelection()

        if t_oColor <> None:
            
            self.widgets['CRGBBorderColor'].modify_bg(gtk.STATE_NORMAL,t_oColor)
