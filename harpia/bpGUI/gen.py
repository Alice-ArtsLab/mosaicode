...
class Properties( GladeWindow, S2iCommonProperties ):
    ...
    m_oPropertiesXML = PropertiesXML
    m_oS2iBlockProperties = S2iBlockProperties
    m_oOutputMap = OutputMap

    #----------------------------------------------------------------------

    def __init__( self ):

        filename = '../etc/rotate/rotate.ui'
    ...
    def on_prop_confirm_clicked( self, *args ):
			...
			if self.widgets['propDisable'].get_active() == self.m_oS2iBlockProperties.GetState():
