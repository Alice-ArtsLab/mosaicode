...
class Properties( GladeWindow, S2iCommonProperties ):
    ...
    def __init__( self, PropertiesXML, S2iBlockProperties):
        ...
        handlers = [
            'on_CLOSBackColorButton_clicked',
            'on_CLOSBorderColorButton_clicked',
            'on_closing_cancel_clicked',
        ...
        self.widgets['CLOSBorderColor'].modify_bg(gtk.STATE_NORMAL,t_oBorderColor)        
        ...
        self.widgets['CLOSBackgroundColor'].modify_bg(gtk.STATE_NORMAL,t_oBackColor)
        ...
        self.widgets['CLOSHelpView'].set_buffer( t_oTextBuffer )
    ...
    def on_closing_cancel_clicked( self, *args ):
    ...
    def on_CLOSBackColorButton_clicked(self,*args):

        t_oColor = self.RunColorSelection()

        if t_oColor <> None:
            
            self.widgets['CLOSBackgroundColor'].modify_bg(gtk.STATE_NORMAL,t_oColor)
    ...
    def on_CLOSBorderColorButton_clicked(self,*args):

        t_oColor = self.RunColorSelection()

        if t_oColor <> None:
            
            self.widgets['CLOSBorderColor'].modify_bg(gtk.STATE_NORMAL,t_oColor)
